...
const options = [
  ...
  },
  {
    ...
    type: 'string',
    default:
      '{{commitMessagePrefix}}{{commitMessageAction}} {{commitMessageTopic}}{{#if commitMessageVersion}} to {{commitMessageVersion}}{{/if}}{{commitMessageSuffix}}',
    cli: false,
  },
  {
    name: 'commitBody',
  ...
  {
    name: 'commitMessageVersion',
    description: 'The version string used in commit messages and PR titles',
    type: 'string',
    default:
      '{{#if newVersion}}{{#unless isRange}}v{{/unless}}{{#if isMajor}}{{newVersionMajor}}{{else}}{{newVersion}}{{/if}}{{/if}}',
    cli: false,
  },
  {
    name: 'prTitle',
    description: 'Pull Request title template (deprecated)',
    type: 'string',
    default: null,
    cli: false,
  },
  ...
  },
  {
    ...
    default: {
      ...
      commitMessageTopic: '{{groupName}} dependencies',
  ...
  },
  {
    ...
    default: {
      ...
      digest: {
        ...
        commitMessageVersion: '{{newDigestShort}}',
